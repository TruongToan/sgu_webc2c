    ...
    internal sealed class Configuration : DbMigrationsConfiguration<SGUStoreServiceContext>
    {
        ...
        protected override void Seed(SGUStoreServiceContext context)
        {
            var users = new List<User>()
            {
                ...
                new User() { Id = 2, UserName = "linh", Email = "linh@gmail.com" },
                new User() { Id = 3, UserName = "toan", Email = "toan@gmail.com" },
                new User() { Id = 4, UserName = "linhhuynh", Email = "linhhuynh@gmail.com" },
                new User() { Id = 5, UserName = "truongtoan", Email = "truongtoan@gmail.com" },
            ...
            {
                new Auction() {Name = "Samsung Galaxy A8 - A800VE", Description = "Samsung Galaxy A8 - A800VE",
                ...
                new Auction() {Name = "Lenovo A7000 Plus", Description = "Lenovo A7000 Plus",
                    ...
                    StartTime = DateTime.Now,
                    EndTime = DateTime.Now},
                new Auction() {Name = "Samsung Galaxy Note 5", Description = "Samsung Galaxy Note 5",
                ...
                new Auction() {Name = "HTC One A9", Description = "HTC One A9",
                    ...
                    StartTime = DateTime.Now,
                    EndTime = DateTime.Now},
                new Auction() {Name = "Samsung Galaxy S6 Edge Plus", Description = "Samsung Galaxy S6 Edge Plus",
                ...
                new Auction() {Name = "LG G4 Leather", Description = "LG G4 Leather",
                    ...
                    StartTime = DateTime.Now,
                    EndTime = DateTime.Now},
                new Auction() {Name = "HP Stream 13 N2840/2GB/32GB/Win8.1", Description = "HP Stream 13 N2840/2GB/32GB/Win8.1",
                    ...
                    StartTime = DateTime.Now,
                    EndTime = DateTime.Now},
                new Auction() {Name = "Dell Inspiron 3458 i3 4005U/4G/500G/Win8.1", Description = "Dell Inspiron 3458 i3 4005U/4G/500G/Win8.1",
                    ...
                    StartTime = DateTime.Now,
                    EndTime = DateTime.Now},
                new Auction() {Name = "Asus E402MA N2840/2GB/500GB/Win10", Description = "Asus E402MA N2840/2GB/500GB/Win10",
                    ...
                    StartTime = DateTime.Now,
                    EndTime = DateTime.Now},
                new Auction() {Name = "Acer ES1 431 N3050/4GB/500GB/Win10", Description = "Acer ES1 431 N3050/4GB/500GB/Win10",
                    ...
                    StartTime = DateTime.Now,
                    EndTime = DateTime.Now},
                new Auction() {Name = "Lenovo Yoga 500 14IBD i3 5020U/4GB/500GB/Touch/Win10", Description = "Lenovo Yoga 500 14IBD i3 5020U/4GB/500GB/Touch/Win10",
                    ...
                    StartTime = DateTime.Now,
                    EndTime = DateTime.Now},
                new Auction() {Name = "HP Pavilion 14 ab133TU i5 5200U/4GB/500GB/Win10", Description = "HP Pavilion 14 ab133TU i5 5200U/4GB/500GB/Win10",
                    ...
                    StartTime = DateTime.Now,
                    EndTime = DateTime.Now},
                new Auction() {Name = "Dell XPS 13 i5 5200U/4GB/128GB/Win10Home", Description = "Dell XPS 13 i5 5200U/4GB/128GB/Win10Home",
                    ...
                    StartTime = DateTime.Now,
                    EndTime = DateTime.Now},
                new Auction() {Name = "Ốp lưng Xperia M4 nhựa phủ sơn XMobile", Description = "Ốp lưng Xperia M4 nhựa phủ sơn XMobile",
                    ...
                    StartTime = DateTime.Now,
                    EndTime = DateTime.Now},
                new Auction() {Name = "Pin sạc dự phòng 6000 mAh X mobile XR02", Description = "Pin sạc dự phòng 6000 mAh X mobile XR02",
                    ...
                    StartTime = DateTime.Now,
                    EndTime = DateTime.Now},
                new Auction() {Name = "Cáp micro USB X mobile", Description = "Cáp micro USB X mobile",
                    ...
                    StartTime = DateTime.Now,
                    EndTime = DateTime.Now},
                new Auction() {Name = "Cáp cao cấp iWalk iPhone 5 / 6", Description = "Cáp cao cấp iWalk iPhone 5 / 6",
                    ...
                    StartTime = DateTime.Now,
                    EndTime = DateTime.Now},
                new Auction() {Name = "USB Apacer AH328 8GB 2.0", Description = "USB Apacer AH328 8GB 2.0",
                    ...
                    StartTime = DateTime.Now,
                    EndTime = DateTime.Now},
                new Auction() {Name = "ElfYourself - Ghép mặt vào Video vũ điệu giáng sinh", Description = "ElfYourself - Ghép mặt vào Video vũ điệu giáng sinh",
