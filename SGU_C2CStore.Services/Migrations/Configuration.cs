    ...
    internal sealed class Configuration : DbMigrationsConfiguration<SGUStoreServiceContext>
    {
        ...
        protected override void Seed(SGU_C2CStore.Services.DAL.SGUStoreServiceContext context)
        {
            ...
            var Products = new List<Product>()
            {
                ...
                new Product() {Name = "Product 4", Description = "A product 4", Price=13, CategoryId=1, CreateTime = DateTime.Now, UpdateTime = DateTime.Now, Owner = u},
                new Product() {Name = "Product 5", Description = "A product 5", Price=14, CategoryId=1, CreateTime = DateTime.Now, UpdateTime = DateTime.Now, Owner = u},
                new Product() {Name = "Product 6", Description = "A product 6", Price=15, CategoryId=4, CreateTime = DateTime.Now, UpdateTime = DateTime.Now, Owner = u},
                new Product() {Name = "Product 7", Description = "A product 7", Price=16, CategoryId=3, CreateTime = DateTime.Now, UpdateTime = DateTime.Now, Owner = u},
                new Product() {Name = "Product 8", Description = "A product 8", Price=17, CategoryId=3, CreateTime = DateTime.Now, UpdateTime = DateTime.Now, Owner = u},
                new Product() {Name = "Product 9", Description = "A product 9", Price=18, CategoryId=1, CreateTime = DateTime.Now, UpdateTime = DateTime.Now, Owner = u}
            };
